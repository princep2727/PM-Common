            ...
            <header className="fixed top-0 left-0 right-0 z-50 h-16 border-b border-gray-200/50 dark:border-white/10 bg-white/80 dark:bg-black/80 backdrop-blur-xl">
                <div className="max-w-7xl mx-auto px-4 h-full flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {/* User Profile / Auth */}
                        {user ? (
                            <div className="relative group ml-3 pl-3 border-l border-gray-200 dark:border-white/10">
                                <button className="flex items-center gap-3 focus:outline-none theme-transition hover:opacity-80">
